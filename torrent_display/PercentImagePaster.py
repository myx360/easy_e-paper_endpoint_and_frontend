...
class PercentImagePaster(ImagePaster):
    percent_per_chilli_segment = (100.0/9.0)

    def __init__(self, epaper_image: EpaperImage, xy, percent):
    ...
    def paste_image(self):
        for i, chilli_image in enumerate(self.chillies_to_print):
            self.epaper_image.paste(chilli_image, (self.__xy[0] + i * chilli_image.size[0], self.__xy[1]))
